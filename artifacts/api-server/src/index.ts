...
const PRESET_SEED = [
  ...
  // ── BI-POLAR ──────────────────────────────────────────────────────────────
  { name: "ПОЛОВИНКА",   description: "Левая — счастье. Правая — горе. Правда жизни на запястье.",       collectionName: "BI-POLAR", watchfaceGeometry: "circle", watchfaceMaterial: "plastic", watchfaceColor: "#f7e28a", braceletMaterial: "resin",         braceletType: "solid", braceletColor: "#6b7280", handsEnabled: false, handsColor: "#1a1a1a", watchfaceText: "EYE:halfmood",  watchfaceTextMode: "center", priceStars: 16, maxQuantity: 1000 },
  { name: "КАПЛИ",       description: "Просто капли. Много. Везде. Не плачем — так получилось.",          collectionName: "BI-POLAR", watchfaceGeometry: "circle", watchfaceMaterial: "plastic", watchfaceColor: "#dbeafe", braceletMaterial: "resin",         braceletType: "solid", braceletColor: "#93c5fd", handsEnabled: false, handsColor: "#1e40af", watchfaceText: "EYE:drops",     watchfaceTextMode: "center", priceStars: 13, maxQuantity: 1000 },
  { name: "СОЛНЫШКО",    description: "Всё лучики. Ярко до боли в глазах. Хорошо же.",                   collectionName: "BI-POLAR", watchfaceGeometry: "circle", watchfaceMaterial: "plastic", watchfaceColor: "#fef08a", braceletMaterial: "resin",         braceletType: "solid", braceletColor: "#fde047", handsEnabled: false, handsColor: "#713f12", watchfaceText: "EYE:sunny",     watchfaceTextMode: "center", priceStars: 14, maxQuantity: 1000 },
  { name: "MOOD",        description: "Просто слово. Никаких объяснений. Сам разберись.",                 collectionName: "BI-POLAR", watchfaceGeometry: "drawn",  watchfaceMaterial: "plastic", watchfaceColor: "#6d28d9", braceletMaterial: "resin",         braceletType: "solid", braceletColor: "#a855f7", handsEnabled: true,  handsColor: "#fde68a", watchfaceText: "MOOD",          watchfaceTextMode: "center", priceStars: 15, maxQuantity: 1000 },
  { name: "СЛЁЗЫ",       description: "Глаза смотрят. Слёзы — вниз. Как стрелки. Тихо.",                 collectionName: "BI-POLAR", watchfaceGeometry: "circle", watchfaceMaterial: "plastic", watchfaceColor: "#0ea5e9", braceletMaterial: "resin",         braceletType: "solid", braceletColor: "#38bdf8", handsEnabled: false, handsColor: "#ffffff", watchfaceText: "EYE:cry",       watchfaceTextMode: "center", priceStars: 17, maxQuantity: 1000 },
  { name: "ГРОЗА",       description: "Молния в центре. Всё остальное сгорело. Нормально.",               collectionName: "BI-POLAR", watchfaceGeometry: "square", watchfaceMaterial: "plastic", watchfaceColor: "#1e1b4b", braceletMaterial: "resin",         braceletType: "solid", braceletColor: "#312e81", handsEnabled: true,  handsColor: "#fbbf24", watchfaceText: "EYE:lightning", watchfaceTextMode: "center", priceStars: 18, maxQuantity: 1000 },
  // ── РОФЛ ──────────────────────────────────────────────────────────────────
